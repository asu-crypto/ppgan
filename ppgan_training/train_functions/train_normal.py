...
def train_normal(args):
    ...
    if args.model_type == "fc":
        if args.dataset.lower() == "mnist":
            gen = FC_Generator(args)#MLP_Disc(True,args.activation_type, 0, args.zdim, 64, 128, 256, 512, 1024, 784)
            disc= MLP_Disc(False,args.activation_type, 0, 784, 512, 256, 1)
        else:
        ...
        if args.dataset.lower() == "mnist":
            ...
            gen = DCGenerator2()#(args)
            disc = CNN_Disc2(0, (3,128,4,2,1),(128,256,4,2,1),(256,512,4,2,1),(512,1024,4,2,1),(1024,1,4,1,0))#(3,16,3,2,1),(16,32,3,2,1),(32,64,3,2,1),(64,128,3,2,1))
    ...
    while iteration < args.iteration_number:
        for img, _ in dataloader:
            ...
            fake_output = disc(gen(get_noise(args)))
